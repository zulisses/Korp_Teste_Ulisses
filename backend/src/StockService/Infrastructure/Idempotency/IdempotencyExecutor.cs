...
public sealed class IdempotencyExecutor(StockDbContext db, TimeProvider timeProvider)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var responseBody = JsonSerializer.Serialize(response.Body, JsonOptions);
